...
BzEntry *bz_hardware_support_dialog_get_entry (BzHardwareSupportDialog *self);

void bz_hardware_support_dialog_set_entry (BzHardwareSupportDialog *self, BzEntry *entry);
